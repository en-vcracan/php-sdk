        ...
        switch ($this->gatewayProvider) {
            ...
            case GatewayProvider::GP_API:
                ...
                if (empty($this->apiVersion)) {
                    throw new ConfigurationException('API Version is required for this configuration');
                }
                if (empty($this->accessTokenManager)) {
                    throw new ConfigurationException('An Access Token Manager is required for this configuration');
                }
                break;
